        ...
        for w in self:
            ...
            for empleado in empleados:
                ...
                if empleado.primer_nombre:
                    ...
                    hoja_empleado.write(fila, 3, empleado.tercer_nombre if empleado.tercer_nombre else '')
                    hoja_empleado.write(fila, 4, empleado.primer_apellido if empleado.primer_apellido else '')
                    hoja_empleado.write(fila, 5, empleado.segundo_apellido if empleado.segundo_apellido else '')
                    hoja_empleado.write(fila, 6, empleado.apellido_casada if empleado.apellido_casada else '')
                    hoja_empleado.write(fila, 7, empleado.nacionalidad)
                    hoja_empleado.write(fila, 8, empleado.tipo_discapacidad)
                    hoja_empleado.write(fila, 9, estado_civil)
                    hoja_empleado.write(fila, 10, empleado.documento_identificacion)
                    hoja_empleado.write(fila, 11, empleado.identification_id)
                    ...
                    hoja_empleado.write(fila, 19, empleado.nivel_academico)
                    hoja_empleado.write(fila, 20, empleado.profesion)
